...
; Credit:
;
; This file is Part 27 of Chapter 8 of the ZX Spectrum +3
; manual, transcribed by Russell Marks et al. and published in
; HTML format in <http://worldofspectrum.org>.  I simply
; converted it to be usable as Z80 source.
...
; 2015-01-12: Start.
;
; 2015-07-13: Add labels for DOS GET 1346 and DOS SET 1346.
; Fix typos (also in the original HTML document).
;
; 2017-02-06: Add all symbols for low-level "DD" entry points.
; Improve the credit note.
...
dd_write_sector: equ 0x0166 ; (358)
...
dd_check_sector: equ 0x0169 ; (361)
...
dd_test_unsuitable: equ 0x0172 ; (370)
...
dd_drive_status: equ 0x017e ; (382)
...
dd_l_t_off_motor: equ 0x0199 ; (409)
...
; +3DOS constants
OPEN_ACTION_ERROR_EXISTS            equ 0
OPEN_ACTION_READ_HEADER             equ 1
OPEN_ACTION_IGNORE_HEADER           equ 2
OPEN_ACTION_MAKE_BACKUP             equ 3
OPEN_ACTION_OVERWRITE               equ 4

CREATE_ACTION_DONT_CREATE           equ 0
CREATE_ACTION_WITH_HEADER           equ 1
CREATE_ACTION_WITHOUT_HEADER        equ 2

FILE_TYPE_BASIC                     equ 0
FILE_TYPE_NUM_ARRAY                 equ 1
FILE_TYPE_CHR_ARRAY                 equ 2
FILE_TYPE_BYTES                     equ 3

ACCESS_MODE_EXCLUSIVE_READ          equ 1
ACCESS_MODE_EXCLUSIVE_WRITE         equ 2
ACCESS_MODE_EXCLUSIVE_READ_WRITE    equ 3
ACCESS_MODE_SHARED                  equ 5
